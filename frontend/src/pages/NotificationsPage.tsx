            ...
            <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm overflow-hidden">
                <div className="px-8 py-6 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        {unreadCount > 0 && (
                            <span className="px-3 py-1 bg-rose-100 text-rose-600 text-xs font-black rounded-full">
                                {unreadCount} unread
                            </span>
                        )}
                    </div>
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 px-4">
                        ...
                        <p className="text-slate-400 font-black text-lg mb-2">No notifications</p>
                        <p className="text-slate-400 text-sm">You'll receive notifications when there are new updates</p>
                    </div>
                ) : (
